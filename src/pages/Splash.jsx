...
const Splash = () => {
  ...
  return (
    <div className="w-screen min-h-screen bg-dark_blue ">
      <div
        className="image-content w-full h-lg_scr"
        style={{
      ...
      >
        ...
        >
          <svg
            ...
            className="p-10 place-content-center m-auto lg:w-1/2"
          >
            <defs></defs>
          ...
          <div className="flex flex-col items-center text-white mb-10">
            <p>Brzo.</p>
            <p>Jednostavno.</p>
            <p>Pronađite i rezervišite parking.</p>
          </div>
        </div>
      </div>
      <div className="block md:flex md:justify-center">
        <div className="m-6 lg:w-1/4">
          <Button title="Prijavite se" onClick={() => navigate("/login")} />
        </div>
        <div className="m-6 lg:w-1/4">
          <Button title="Registrujte se" onClick={() => navigate("/register")} />
        </div>
      </div>
    </div>
  );
