    ...
    <div className="register-page-content flex">
      ...
      <div className="w-screen h-screen bg-dark_blue overflow-x-hidden lg:w-1/2 h-screen ">
        <div className="w-full h-full text-white p-5 flex flex-col items-start justify-start space-y-10 lg:p-20 lg:place-content-center">
          <h1 className="text-2xl lg:text-3xl font-medium">Registrujte se</h1>
          <div className="max-w-full space-y-5  mx-auto">
